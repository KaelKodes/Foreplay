...
public partial class MainHUDController : CanvasLayer
{
    ...
    public override void _Ready()
    {
        ...
        GetNode<Button>("ObjectGallery/VBox/Scroll/Grid/SignBtn").Pressed += () => SelectObjectToPlace("DistanceSign");
    ...
    private void UpdateHUDForMode(PlayerState state)
    {
        ...
        _buildHUD.Visible = (state == PlayerState.BuildMode);
    ...
    private void SelectObjectToPlace(string objectId)
    {
        ...
        {
            _swingSystem.ObjectPlacer.SpawnAndPlace(scene);
        }
    }
}
